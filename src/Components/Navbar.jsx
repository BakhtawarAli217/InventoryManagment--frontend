    ...
    <nav>
      ...
      <div className="nav-routes">
        <ul>
          ...
          <li className={location.pathname==="/brand" ? "Active-Location" : ""}>
            <Link to="/brand">
              <p>
                <svg
                  width="20"
          ...
          <li className={location.pathname==="/Models" ? "Active-Location" : ""}>
            <Link to="/models">
              <p>
                <svg
                  width="18"
          ...
          <li className={location.pathname==="/Add-iventory" ? "Active-Location" : ""}>
